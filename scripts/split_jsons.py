...
for t in jsons_names:
	if t in train:
		shutil.copy(os.path.join(args.path_annotation_jsons, t), os.path.join(train_folder, t))
		# os.system('cp '+args.path_annotation_jsons+'/'+t+' '+train_folder+'/'+t)
	if t in test:
		shutil.copy(os.path.join(args.path_annotation_jsons, t), os.path.join(test_folder, t))
		# os.system('cp '+args.path_annotation_jsons+'/'+t+' '+test_folder+'/'+t)
	if t in val:
		shutil.copy(os.path.join(args.path_annotation_jsons, t), os.path.join(val_folder, t))
